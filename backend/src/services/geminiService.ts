...
const responseSchema = {
  ...
  properties: {
    ...
    customerName: {
      type: Type.STRING,
      nullable: true,
      description: "The customer's name as spoken, or null if none was mentioned.",
    },
    amount: {
      type: Type.NUMBER,
      nullable: true,
...
The shopkeeper recorded a short voice note, usually in a mix of Hindi and English, naming a customer, an
amount of money owed (in rupees), and optionally what they bought. Transcribe the audio, then extract:
- customerName: the customer's name as spoken (or null if unclear/not mentioned)
      ...
      items: {
        ...
        properties: {
          customerName: {
            type: Type.STRING,
            nullable: true,
            description: "The customer's name as handwritten, or null if illegible/not present.",
          },
          amount: {
            type: Type.NUMBER,
            nullable: true,
...
The photo shows one page of the notebook. Each line or row generally records one customer's purchase on
credit: a customer name and a rupee amount, sometimes with a short list of items. Extract every such row
you can find on the page:
- customerName: the customer's name as handwritten (or null if illegible or not present on that row)
